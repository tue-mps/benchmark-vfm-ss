...
<img width="420" alt="image" src="https://github.com/tue-mps/benchmark-vfm-ss/assets/6392002/d63995bf-e05b-4829-8d4c-b751a7d552ca">
...
4. **Fine-tune a model:**  
   Here's an example for fine-tuning DINOv2 with the default setup on GPU 0 with 1 worker for data loading 
   ```bash
